...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, username, password FROM student_registration WHERE username = '$entered_username'";
...
<body>
    ...
    <section>
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <h3>Don't have an Account? Register <a href="studentReg.php">Here</a></h3>
