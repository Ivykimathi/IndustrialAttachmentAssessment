...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($phone) || empty($password) || empty($confirm_password)) {
        ...
        $check_username = "SELECT id FROM lecturer_reg WHERE username = '$username'";
        ...
        if ($result->num_rows > 0) {
            ...
            if ($password != $confirm_password) {
                ...
                $sql = "INSERT INTO lecturer_reg (username, phone, password) VALUES ('$username', '$phone', '$hashed_password')";

                if ($conn->query($sql) === TRUE) {
                    $message = "Registration successful! You can now <a href='lecturerLogin.php'>login</a>.";
                } else {
...
<body>
    ...
    <section>
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <h3>Already have an Account? Login <a href="lecturerLogin.php">Here</a></h3>
        </form>
    </section>
     <!-- ======= Footer ======= -->
  <centre>
